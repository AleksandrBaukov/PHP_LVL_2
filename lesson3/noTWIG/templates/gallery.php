...
if(mysqli_num_rows($res)>0){
    while ($data = mysqli_fetch_assoc($res)){
        ...
        <a href="bigphoto.php?id=<?=$data['id']?>" target="_blank"><img src="<?=$smallImage?>" alt="pic"></a>
        <div>
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                 width="15px" height="15px" viewBox="0 0 497.25 497.25" style="enable-background:new 0 0 497.25 497.25;"
                 xml:space="preserve"><circle cx="248.625" cy="248.625" r="19.125"/>
